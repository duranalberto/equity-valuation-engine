...
def print_tabulated_metrics(stock: StockMetrics):
    ...
    # safe_div guards against ZeroDivisionError when revenue_ttm == 0.0
    ev_revenue = safe_div(val.enterprise_value, fin.revenue_ttm)
    print(tabulate([
        ["EV / Revenue (TTM)", fmt_num(ev_revenue)],
