...
class PEChecker(ValuationChecker):
    ...
    def _check_earnings_stability(self):
        ...
        if pe_ttm is not None and pe_ttm > 40:
            self._add_factor("Very High P/E", f"P/E (TTM) is high: {pe_ttm:.1f}, indicating high market expectations.", FactorSeverity.WARNING, pe_ttm)
    ...
    def _check_growth_metrics(self):
        ...
        if peg_ratio is not None and peg_ratio < 0:
            ...
            self._add_factor("High PEG Ratio", f"PEG Ratio is high: {peg_ratio:.2f}. May indicate significant overvaluation.", FactorSeverity.WARNING, peg_ratio)
